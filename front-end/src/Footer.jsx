                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-10">
                                        <div className="card-body p-0">
                                            <h5>{t('freeDeliveryTitle')}</h5>
                                            <p className="card-text">{t('freeDeliveryText')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col">
                            <div className="card mb-3 border-0">
                                <div className="row">
                                    ...
                                    <div className="col-md-10">
                                        <div className="card-body p-0">
                                            <h5>{t('securePaymentTitle')}</h5>
                                            <p className="card-text">{t('securePaymentText')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col">
                            <div className="card mb-3 border-0">
                                <div className="row">
                                    ...
                                    <div className="col-md-10">
                                        <div className="card-body p-0">
                                            <h5>{t('qualityGuaranteeTitle')}</h5>
                                            <p className="card-text">{t('qualityGuaranteeText')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col">
                            <div className="card mb-3 border-0">
                                <div className="row">
                                    ...
                                    <div className="col-md-10">
                                        <div className="card-body p-0">
                                            <h5>{t('guaranteedSavingsTitle')}</h5>
                                            <p className="card-text">{t('guaranteedSavingsText')}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
